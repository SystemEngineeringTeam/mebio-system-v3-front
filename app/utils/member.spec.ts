...
describe('部員の詳細情報 (現役生)', () => {
  it('内部生の判定ができるか', () => {
    ...
    const result = toMemberDetailActive(client, builder, data);
  ...
  it('不正なデータを異常系として判定できるか', () => {
    ...
    expect(() => toMemberDetailActive(client, builder, data)).toThrow();

    const data2 = {};
    expect(() => toMemberDetailActive(client, builder, data2)).toThrow();
  });
});
...
describe('部員の詳細情報', () => {
  it('現役生の判定ができるか', () => {
    ...
    const result = toMemberDetail(client, builder, data);
    expect(result.type).toBe('ACTIVE');

    const data2 = { MemberActive, MemberActiveExternal };
    const result2 = toMemberDetail(client, builder, data2);
  ...
  it('不正なデータを異常系として判定できるか', () => {
    ...
    expect(() => toMemberDetail(client, builder, data)).toThrow();

    const data2 = {};
    expect(() => toMemberDetail(client, builder, data2)).toThrow();
  });
});
