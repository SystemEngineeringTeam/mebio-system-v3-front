...
export const MemberActive = (<M extends ModelMode>(client: PrismaClient) => class MemberActive<Mode extends ModelMode = M> {
...
export type $MemberActive<M extends ModelMode = 'DEFAULT'> = typeof MemberActive<M>;
